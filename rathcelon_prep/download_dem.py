...
#     return filename
#
# def download_dems(lhd_df, dem_folder):
#     """
...
#     dem_folder: folder where DEM subdirectories will be stored
#     """
#     lhd_df["dem_loc"] = "" # initialize column with dem locations
...
#         dem_subdir =   f"{dem_folder}/{title}"
#         os.makedirs(dem_subdir, exist_ok=True) # if the directory already exists, it won't freak out
#         dem_path = f"{dem_subdir}/{title}.tiff"
#         lhd_df.at[index, "dem_loc"] = dem_subdir # save the path to the specific dem folder to the DataFrame
#
